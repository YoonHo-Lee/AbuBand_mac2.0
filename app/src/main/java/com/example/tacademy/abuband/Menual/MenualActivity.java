...
//        setSupportActionBar(toolbar);
        ...
        Intent i = getIntent();
        int flag = i.getIntExtra(SettingFragment.MENUAL_FLAG,999);

        Toast.makeText(MenualActivity.this, flag+"", Toast.LENGTH_SHORT).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_menual, menu);
        return true;
    }
