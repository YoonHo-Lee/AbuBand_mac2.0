...
public class LineView extends View {
    ...
    private final int BOTTOM_TEXT_COLOR = Color.parseColor("#4b5158");
    ...
    //popup 컬러
    private int[] popupColorArray = {R.drawable.popup_white,R.drawable.popup_blue,R.drawable.popup_green};
